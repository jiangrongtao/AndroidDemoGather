...
import com.daimajia.slider.library.Transformers.FlipVerticalTransformer;
...
import com.daimajia.slider.library.Transformers.ZoomRotateOutTransformer;
 ...
 *
 */
public class SliderLayout extends RelativeLayout implements NestedScrollingChild{
    ...
    public void setPresetTransformer(Transformer ts){
        ...
        switch (ts){
            ...
            case FlipVertical:
                ...
                break;
            case ZoomRotateOut:
                t = new ZoomRotateOutTransformer();
                break;
        }
